...
const API_URL = "https://skilledlink-f4lp.onrender.com";
  ...
  useEffect(() => {
    const fetchPortfolio = async () => {
      ...
      try {
        ...
        // Agar real data fail ho jaye toh ek blank default structure de dein taaki app crash na ho
        setPortfolioData({
  ...
  // Ab p ko portfolioData se map kar diya hai
  const p = portfolioData;
  if (!p) return null;

  // Rank Colors waise ke waise hi hain
                ...
                {p.projects.map(pr => (
                  ...
                  >
                    <div style={{
                      ...
                      <span style={{ fontSize: "15px", fontWeight: 700, color: "#2d1f6e" }}>
                        {pr.name || pr.title}
                      </span>
                    ...
                    <p style={{ margin: 0, fontSize: "13px", color: "#555", lineHeight: 1.55 }}>
                      {pr.desc || pr.description}
                    </p>
                  </div>
                ))}
              </div>
                ...
                {p.experience.map(ex => (
                  ...
                  >
                    <div style={{
                      ...
                      height: "42px",
                      borderRadius: "12px",
                      background: "linear-gradient(135deg,#ede8fb,#ddd5f7)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: "20px",
                    ...
                    <div>
                      <div style={{ fontSize: "14px", fontWeight: 700, color: "#2d1f6e" }}>
                        {ex.role}
                      </div>
                      <div style={{ fontSize: "13px", color: "#553f9a", fontWeight: 600 }}>
                        {ex.company}
                      </div>
