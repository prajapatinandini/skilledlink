...
const SuperAdminDashboard = () => {
  ...
  // 🟢 NAYA STATE: Jis company par click kiya, uski details yahan save hongi
      ...
      {selectedCompany && (
        <div style={{
          ...
          <div style={{ background: "white", padding: "30px", borderRadius: "12px", width: "400px", boxShadow: "0 10px 25px rgba(0,0,0,0.2)" }}>
            <h2 style={{ margin: "0 0 20px 0", color: "#1e293b", borderBottom: "2px solid #f1f5f9", paddingBottom: "10px" }}>
              🏢 Company Profile
            </h2>
            ...
            {/* Agar schema me phone ya location hai to yaha dikhega */}
            ...
            <div style={{ marginBottom: "15px" }}>
              <strong>Joined On:</strong> {new Date(selectedCompany.createdAt).toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })}
            </div>
